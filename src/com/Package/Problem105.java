...
*/
                                ...
                                for(int o3 = o2 + 1; o3 < set.length; o3++){
                                    ...
                                    for(int o4 = o3 + 1; o4 < set.length; o4++){
                                        if (o4 == e1 || o4 == e2 || o4 == e3 || o4 == e4)
                                            continue;
                                        if (set[o1] + set[o2] + set[o3] + set[o4] == mainSum2)
                                            return false;
                                    }
                                }
                            }
                                ...
                                for(int o2 = o1 + 1; o2 < set.length; o2++) {
                                    ...
                                    for(int o3 = o2 + 1; o3 < set.length; o3++){
                                        if (o3 == e1 || o3 == e2 || o3 == e3 || o3 == e4 || o3 == e5)
                                            continue;
                                        if (set[o1] + set[o2] + set[o3] >= mainSum3)
                                            return false;
                                    }
                                }
                            }
                                ...
                                for(int o1 = 0; o1 < set.length; o1++){
                                    ...
                                    for(int o2 = o1 + 1; o2 < set.length; o2++) {
                                        if (o2 == e1 || o2 == e2 || o2 == e3 || o2 == e4 || o2 == e5 || o2 == e6)
                                            continue;
                                        if (set[o1] + set[o2] >= mainSum4)
                                            return false;

                                    }
                                }

                                for(int e7 = e6 + 1; e7 < set.length; e7++){
                                    int mainSum5 = mainSum4 + set[e7];
                                    //1 ele:
                                    for(int o1 = 0; o1 < set.length; o1++){
                                    ...
                                    for(int o3 = o2 +1; o3 < set.length; o3++){
                                        ...
                                        for(int o4 = o3 +1; o4 < set.length; o4++){
                                            if (o4 == e1 || o4 == e2 || o4 == e3 || o4 == e4 || o4 == e5)
                                                continue;
                                            if (set[o1] + set[o2] + set[o3] + set[o4] >= mainSum3)
                                                return false;
                                        }
                                    }
                                }
                            ...
                            for(int e6 = e5 + 1; e6 < set.length; e6++){
                                    ...
                                    for(int o2 = o1 + 1; o2 < set.length; o2++) {
                                        ...
                                        for(int o3 = o2 + 1; o3 < set.length; o3++) {
                                            if (o3 == e1 || o3 == e2 || o3 == e3 || o3 == e4 || o3 == e5 || o3 == e6)
                                                continue;
                                            if (set[o1] + set[o2] + set[o3] >= mainSum4)
                                                return false;
                                        }
                                    }
                                }
                                ...
                                for(int e7 = e6 + 1; e7 < set.length; e7++){
                                    ...
                                    for(int o1 = 0; o1 < set.length; o1++){
                                        ...
                                        if (o1 == e1 || o1 == e2 || o1 == e3 || o1 == e4 || o1 == e5 || o1 == e6 || o1 == e7)
                                            continue;
                                        if (set[o1] >= mainSum5)
                                            return false;

                                        for(int o2 = o1 + 1; o2 < set.length; o2++) {
                                            if (o2 == e1 || o2 == e2 || o2 == e3 || o2 == e4 || o2 == e5 || o2 == e6 || o2 == e7)
                                                continue;
                                            if (set[o1] + set[o2] >= mainSum5)
                                                return false;

                                        }
                                    }

                                    for(int e8 = e7 + 1; e8 < set.length; e8++){
                                        int mainSum6 = mainSum5 + set[e8];
                                        //1 ele:
                                        for(int o1 = 0; o1 < set.length; o1++){
    ...
    public boolean check10(int[] set){
                                        ...
                                        for(int o4 = o3 +1; o4 < set.length; o4++){
                                            ...
                                            for(int o5 = o4 +1; o5 < set.length; o5++){
                                                if (o5 == e1 || o5 == e2 || o5 == e3 || o5 == e4 || o5 == e5)
                                                    continue;
                                                if (set[o1] + set[o2] + set[o3] + set[o4] + set[o5] == mainSum3)
                                                    return false;
                                            }
                                        }
                                    }
                                        ...
                                        for(int o3 = o2 + 1; o3 < set.length; o3++) {
                                            ...
                                            for(int o4 = o3 + 1; o4 < set.length; o4++) {
                                                if (o4 == e1 || o4 == e2 || o4 == e3 || o4 == e4 || o4 == e5 || o4 == e6)
                                                    continue;
                                                if (set[o1] + set[o2] + set[o3] + set[o4] >= mainSum4)
                                                    return false;
                                            }
                                        }
                                    }
                                ...
                                for(int e7 = e6 + 1; e7 < set.length; e7++){
                                    ...
                                    for(int o1 = 0; o1 < set.length; o1++){
                                        ...
                                        for(int o2 = o1 + 1; o2 < set.length; o2++) {
                                            ...
                                            for(int o3 = o2 + 1; o3 < set.length; o3++) {
                                                if (o3 == e1 || o3 == e2 || o3 == e3 || o3 == e4 || o3 == e5 || o3 == e6 || o3 == e7)
                                                    continue;
                                                if (set[o1] + set[o2] + set[o3] >= mainSum5)
                                                    return false;
                                            }
                                        }
                                    }
                                        ...
                                        for(int o1 = 0; o1 < set.length; o1++){
                                            ...
                                            for(int o2 = o1 + 1; o2 < set.length; o2++) {
                                                if (o2 == e1 || o2 == e2 || o2 == e3 ||
                                                    ...
                                                    o2 == e7 || o2 == e8)
                                                    continue;
                                                if (set[o1] + set[o2] >= mainSum6)
                                                    return false;

                                            }
                                        }

                                        for(int e9 = e8 + 1; e9 < set.length; e9++){
                                            int mainSum7 = mainSum6 + set[e9];
                                            //1 ele:
                                            for(int o1 = 0; o1 < set.length; o1++){
    ...
    public boolean check11(int[] set){
                                            ...
                                            for(int o4 = o3 + 1; o4 < set.length; o4++) {
                                                ...
                                                for(int o5 = o4 + 1; o5 < set.length; o5++) {
                                                    if (o5 == e1 || o5 == e2 || o5 == e3 || o5 == e4 || o5 == e5 || o5 == e6)
                                                        continue;
                                                    if (set[o1] + set[o2] + set[o3] + set[o4] + set[o5] >= mainSum4)
                                                        return false;
                                                }
                                            }
                                        }
                                    ...
                                    for(int o1 = 0; o1 < set.length; o1++){
                                        ...
                                        for(int o2 = o1 + 1; o2 < set.length; o2++) {
                                            ...
                                            for(int o3 = o2 + 1; o3 < set.length; o3++) {
                                                ...
                                                for(int o4 = o3 + 1; o4 < set.length; o4++) {
                                                    if (o4 == e1 || o4 == e2 || o4 == e3 ||
                                                        o4 == e4 || o4 == e5 || o4 == e6 ||
                                                        o4 == e7)
                                                        continue;
                                                    if (set[o1] + set[o2] + set[o3] + set[o4] >= mainSum5)
                                                        return false;
                                                }
                                            }
                                        }
                                            ...
                                            for(int o2 = o1 + 1; o2 < set.length; o2++) {
                                                ...
                                                for(int o3 = o2 + 1; o3 < set.length; o3++) {
                                                    if (o3 == e1 || o3 == e2 || o3 == e3 ||
                                                        ...
                                                        o3 == e7 || o3 == e8)
                                                        continue;
                                                    if (set[o1] + set[o2] + set[o3] >= mainSum6)
                                                        return false;
                                                }
                                            }
                                        }
                                            ...
                                            for(int o1 = 0; o1 < set.length; o1++){
                                                ...
                                                for(int o2 = o1 + 1; o2 < set.length; o2++) {
                                                    if (o2 == e1 || o2 == e2 || o2 == e3 ||
                                                        ...
                                                        o2 == e7 || o2 == e8 || o2 == e9)
                                                        continue;
                                                    if (set[o1] + set[o2] >= mainSum7)
                                                        return false;

                                                }
                                            }

                                            for(int e10 = e9 + 1; e10 < set.length; e10++){
                                                int mainSum8 = mainSum7 + set[e10];
                                                //1 ele:
                                                for(int o1 = 0; o1 < set.length; o1++){
    ...
    public boolean check12(int[] set){
                                                ...
                                                for(int o5 = o4 + 1; o5 < set.length; o5++) {
                                                    ...
                                                    for(int o6 = o5 + 1; o6 < set.length; o6++) {
                                                        if (o6 == e1 || o6 == e2 || o6 == e3 || o6 == e4 || o6 == e5 || o6 == e6)
                                                            continue;
                                                        if (set[o1] + set[o2] + set[o3] + set[o4] + set[o5] + set[o6] == mainSum4)
                                                            return false;
                                                    }
                                                }
                                            }
                                        ...
                                        for(int o2 = o1 + 1; o2 < set.length; o2++) {
                                            ...
                                            for(int o3 = o2 + 1; o3 < set.length; o3++) {
                                                ...
                                                for(int o4 = o3 + 1; o4 < set.length; o4++) {
                                                    ...
                                                    for(int o5 = o4 + 1; o5 < set.length; o5++) {
                                                        if (o5 == e1 || o5 == e2 || o5 == e3 ||
                                                            o5 == e4 || o5 == e5 || o5 == e6 ||
                                                            o5 == e7)
                                                            continue;
                                                        if (set[o1] + set[o2] + set[o3] + set[o4] + set[o5] >= mainSum5)
                                                            return false;
                                                    }
                                                }
                                            }
                                                ...
                                                for(int o3 = o2 + 1; o3 < set.length; o3++) {
                                                    ...
                                                    for(int o4 = o3 + 1; o4 < set.length; o4++) {
                                                        if (o4 == e1 || o4 == e2 || o4 == e3 ||
                                                            ...
                                                            o4 == e7 || o4 == e8)
                                                            continue;
                                                        if (set[o1] + set[o2] + set[o3] + set[o4] >= mainSum6)
                                                            return false;
                                                    }
                                                }
                                            }
                                                ...
                                                for(int o2 = o1 + 1; o2 < set.length; o2++) {
                                                    ...
                                                    for(int o3 = o2 + 1; o3 < set.length; o3++) {
                                                        if (o3 == e1 || o3 == e2 || o3 == e3 ||
                                                            ...
                                                            o3 == e7 || o3 == e8 || o3 == e9)
                                                            continue;
                                                        if (set[o1] + set[o2] + set[o3] >= mainSum7)
                                                            return false;
                                                    }
                                                }
                                            }
                                                ...
                                                for(int o1 = 0; o1 < set.length; o1++){
                                                    ...
                                                    for(int o2 = o1 + 1; o2 < set.length; o2++) {
                                                        if (o2 == e1 || o2 == e2 || o2 == e3 ||
                                                            ...
                                                            o2 == e10)
                                                            continue;
                                                        if (set[o1] + set[o2] >= mainSum8)
                                                            return false;

                                                    }
                                                }

                                                for(int e11 = e10 + 1; e11 < set.length; e11++){
                                                    int mainSum9 = mainSum8 + set[e11];
                                                    //1 ele:
                                                    for(int o1 = 0; o1 < set.length; o1++){
